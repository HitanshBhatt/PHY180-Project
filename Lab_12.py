...
filename= "newdata.txt" # change this if your filename is different
...
popt, pcov = optimize.curve_fit(my_func, xdata, ydata, p0=init_guess, maxfev = 100000)
...
ax2.set_ylabel("residuals of Angle [radians]")
